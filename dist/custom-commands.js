...
// ---------------------------------------------------------------------------
async function getRegistry(ctx, companyId) {
...
async function saveRegistry(ctx, companyId, commands) {
    await ctx.state.set({ scopeKind: "company", scopeId: companyId, stateKey: "custom_commands" }, { commands });
}
// ---------------------------------------------------------------------------
// Register a command
// ---------------------------------------------------------------------------
export async function registerCommand(ctx, companyId, command, description, parameters, agentId, agentName) {
...
// ---------------------------------------------------------------------------
export async function executeCommand(ctx, token, channelId, parsed, companyId) {
    const registry = await getRegistry(ctx, companyId);
...
// ---------------------------------------------------------------------------
export async function listCommands(ctx, companyId) {
