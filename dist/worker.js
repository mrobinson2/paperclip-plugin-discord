...
const plugin = definePlugin({
    async setup(ctx) {
        ...
        const voiceEnabled = !!(voiceEnv.guildId &&
        ...
        if (voiceEnabled && gateway.voice) {
            ...
            ctx.logger.info("voice: disabled — missing one of WAR_ROOM_GUILD_ID, WAR_ROOM_VOICE_CHANNEL_ID, MICHAEL_VOICE_WEBHOOK_URL, DEEPGRAM_API_KEY");
        }
