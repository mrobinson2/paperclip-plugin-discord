...
export declare function formatSessionFailure(event: PluginEvent, baseUrl?: string): DiscordMessage;
...
export declare function formatAgentRunStarted(event: PluginEvent, baseUrl?: string): DiscordMessage;
export declare function formatAgentRunFinished(event: PluginEvent, baseUrl?: string): DiscordMessage;
