 ...
 */
export class WebhookTextChannelRelay {
    webhookUrl;
    username;
    constructor(cfg) {
    ...
    async postTranscript(text, _metadata) {
        ...
        if (!resp.ok) {
            ...
            throw new Error(`webhook POST failed: ${resp.status} ${resp.statusText} — ${errBody}`);
        }
    }
}
//# sourceMappingURL=text-channel-relay.js.map