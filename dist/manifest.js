    ...
    instanceConfigSchema: {
        ...
        properties: {
            ...
            publicBaseUrl: {
                ...
                description: "Browser-facing origin used for embed links (View Issue buttons), e.g. https://mission-control.example.com. Falls back to Paperclip Base URL; localhost origins render no links.",
                default: "",
            },
            ...
            enableAgentChat: {
                ...
                description: "Treat standalone (non-reply) messages in the default channel as input to the default agent by creating an assigned issue.",
                default: DEFAULT_CONFIG.enableAgentChat,
            },
            defaultAgentId: {
                type: "string",
                title: "Default agent for war-room chat",
                description: "Paperclip agent UUID assigned to issues created from standalone war-room messages.",
